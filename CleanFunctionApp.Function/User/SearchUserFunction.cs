...
public class SearchUserFunction: Abstraction<SearchUserFunction>
{
    ...
    [OpenApiOperation(operationId: "Get User By Filter", tags: new[] { "User" }, Summary = "Search New User.",
        Description = "Operation Insert new user to database.", Visibility = OpenApiVisibilityType.Important)]
    [OpenApiRequestBody(contentType: "application/json", bodyType: typeof(SearchUserDto), Required = true,
